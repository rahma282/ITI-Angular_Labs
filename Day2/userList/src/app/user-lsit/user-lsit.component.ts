...
@Component({
  selector: 'app-user-lsit',
  imports: [CommonModule, UserCardsComponent],
  templateUrl: './user-lsit.component.html',
 styleUrls: ['./user-lsit.component.css'],
})
export class UserLsitComponent {
